        ...
        tinymce.init(
            {
                ...
                plugins: [
                    ...
                    'insertdatetime media table contextmenu paste code emoticons fontawesome noneditable'
                ],
                content_css: 'http://netdna.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css',
                toolbar: 'insertfile undo redo | styleselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image emoticons fontawesome',
