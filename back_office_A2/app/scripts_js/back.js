System.register(['angular2/core', './components/header/header', './components/login/login', './components/home/home', './components/mongo/mongo', './components/logs/logs', './services/user.service', 'angular2/http', 'angular2/router'], function(exports_1) {
    ...
    var core_1, header_1, login_1, home_1, mongo_1, logs_1, user_service_1, http_1, router_1;
    var WTC_Back;
    return {
        setters:[
            function (core_1_1) {
            ...
            WTC_Back = (function () {
                ...
                WTC_Back = __decorate([
                    core_1.Component({
                        ...
                        directives: [router_1.ROUTER_DIRECTIVES, header_1.HeaderCmp, login_1.LoginCmp, mongo_1.MongoCmp, logs_1.LogCmp],
                        pipes: []
                    }),
                    router_1.RouteConfig([
                        ...
                        { path: '/logs', name: 'Logs', component: logs_1.LogCmp },
